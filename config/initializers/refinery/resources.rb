...
Refinery::Resources.configure do |config|
  ...
  config.max_file_size = 1024*1024*1024
  ...
  # config.dragonfly_secret = "fb4af653a0976eb99058ec2b91db479634911991cc50b089"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/schrecknetuser/sdoctrine/refinery/public/system/refinery/resources"

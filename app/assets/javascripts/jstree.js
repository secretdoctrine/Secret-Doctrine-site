 ...
 */
	 ...
	 * @private
	 * @name $.jstree.core(id)
	 * @param {Number} id this instance's indexes
	 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @param  {mixed}   pos       the indexes at which to insert the node, "first" and "last" are also supported, default is "last"
		...
		set_theme : function (theme_name, theme_url) {
			...
			if(theme_url === true) {
				...
				theme_url = dir + '/' + theme_name + '/jstree.css';
			}
